...
class InlineResponse2001(object):
    ...
    def token(self, token):
        ...
        :type: str
        """
        if token is not None and not re.search(r'^[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89aAbB][a-f0-9]{3}-[a-f0-9]{12}$', token):  # noqa: E501
            raise ValueError(r"Invalid value for `token`, must be a follow pattern or equal to `/^[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89aAbB][a-f0-9]{3}-[a-f0-9]{12}$/`")  # noqa: E501
