...
from iotlabclient.client.models.status_response import StatusResponse  # noqa: E501
...
class TestStatusResponse(unittest.TestCase):
    ...
    def testStatusResponse(self):
        ...
        # model = iotlabclient.client.models.status_response.StatusResponse()  # noqa: E501
        pass
