...
class ExperimentPhysical(object):
    ...
    composed_hierarchy = {
        'anyOf': [],
        'allOf': ["Associations", "CommonExperimentRequest", "ExperimentPhysicalAllOf", "FirmwareAssociations", "ProfileAssociations", "SiteAssociations"],
        'oneOf': [],
    }

    def __init__(self, nodes=None, type='physical', name=None, duration=None, reservation=None, profiles=None, mobilities=None, profileassociations=None, firmwareassociations=None, associations=None, siteassociations=None):  # noqa: E501
