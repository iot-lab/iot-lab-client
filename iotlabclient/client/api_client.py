...
class ApiClient(object):
    ...
    def __call_api(
        ...
        if post_params or files:
            post_params = [] if files else post_params
            post_params = self.sanitize_for_serialization(post_params)
            post_params = self.parameters_to_tuples(post_params,
                                                    collection_formats)
            post_params.extend(self.prepare_post_parameters(files))
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(iotlabclient.client.models, klass)
    ...
    def prepare_post_parameters(self, files=None):
