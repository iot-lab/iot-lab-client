...
class FirmwaresApi(object):
    ...
    def delete_firmware_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `name` when calling `delete_firmware`")  # noqa: E501

        if 'name' in local_var_params and not re.search(r'^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$', local_var_params['name']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `name` when calling `delete_firmware`, must conform to the pattern `/^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_firmware_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Firmware, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ApiValueError("Missing the required parameter `name` when calling `get_firmware`")  # noqa: E501

        if 'name' in local_var_params and not re.search(r'^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$', local_var_params['name']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `name` when calling `get_firmware`, must conform to the pattern `/^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_firmware_file_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ApiValueError("Missing the required parameter `name` when calling `get_firmware_file`")  # noqa: E501

        if 'name' in local_var_params and not re.search(r'^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$', local_var_params['name']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `name` when calling `get_firmware_file`, must conform to the pattern `/^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_firmwares_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[Firmware], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def modify_firmware_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if ('name' not in local_var_params or
                local_var_params['name'] is None):
            raise ApiValueError("Missing the required parameter `name` when calling `modify_firmware`")  # noqa: E501

        if 'name' in local_var_params and not re.search(r'^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$', local_var_params['name']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `name` when calling `modify_firmware`, must conform to the pattern `/^[0-9A-Za-z_-]+(\.[0-9A-Za-z_-]+)?$/`")  # noqa: E501
        collection_formats = {}
