...
class TestExperimentApi(unittest.TestCase):
    ...
    def test_experiments_id_get(self):
        """Test case for experiments_id_get

        Returns experiment.  # noqa: E501
        """
        pass

    def test_experiments_id_nodes_flash_name_post(self):
        """Test case for experiments_id_nodes_flash_name_post

        Send experiment nodes flash firmware store command.  # noqa: E501
        """
        pass

    def test_experiments_id_token_get(self):
        """Test case for experiments_id_token_get
